...
const HeaderNatice: React.FC<NoticeIconProps> & {
	...
	const NoticeBellIcon = bell || <BellOutlined style={{color: '#B3B3B3'}} className={styles.icon}/>;
	const trigger = (
...
HeaderNatice.defaultProps = {
	emptyImage: 'https://gw.alipayobjects.com/zos/rmsportal/wAhyIChODzsoKIOBHcBk.svg',
};

HeaderNatice.Tab = NoticeList;


export default HeaderNatice;
